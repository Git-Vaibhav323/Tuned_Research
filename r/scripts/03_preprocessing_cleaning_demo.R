# =============================================================================
# ResearchPilot — Faculty Demo: Data Preprocessing & Cleaning (in R)
# Rubric mapping : Data preprocessing (missing values, encoding, etc.) (2 marks)
#
# This script RE-DEMONSTRATES cleaning in R so you can show each step live.
# Canonical Python pipeline already produced cleaned/final files; this proves
# the same logic transparently for faculty evaluation.
#
