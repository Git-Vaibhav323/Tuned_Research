...
**Status covered:** M1 · M2 · M3 · **M4** (complete)  
**Next:** M5 (hyperparameter tuning)

## Start here

1. **[DA2_Progress_Report_M1_M2_M3.md](DA2_Progress_Report_M1_M2_M3.md)** — progress through feature selection  
2. **[M4_Model_Training_Report.md](M4_Model_Training_Report.md)** — 14-model training results  
...
- [m4_leaderboard.md](m4_leaderboard.md) / [m4_leaderboard.csv](m4_leaderboard.csv)
