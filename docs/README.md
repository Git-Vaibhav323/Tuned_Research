...
| [development_roadmap.md](development_roadmap.md) | Phase 1–3 roadmap |
| [project_scope.md](project_scope.md) | In-scope / out-of-scope |
| [benchmark_plan.md](benchmark_plan.md) | Evaluation across phases |
