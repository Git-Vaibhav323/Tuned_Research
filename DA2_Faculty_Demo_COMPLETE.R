...
cat("  After selection   : 80   (Mutual Info + correlation filter)\n\n")
...
cat("Method: Mutual Information + Pearson correlation filter\n\n")
...
cat("          206 -> 80 features (RF importance + corr filter)\n\n")
